...
```xml
<PackageReference Condition="!$([MSBuild]::IsTargetFrameworkCompatible('$(TargetFramework)', 'net9.0'))" Include="Backport.System.Threading.Lock" Version="3.0.4-beta" />  
```
...
```xml
<ItemGroup>
  <PackageReference Include="Backport.System.Threading.Lock" Version="3.0.4-beta" />  
